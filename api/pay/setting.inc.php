...
<td class="tl">提示信息：</td>
<td>
以下接口需要申请的是B2C<span class="f_red">即时到帐</span>交易，接口功能类似，一般只需要开通任意一个即可<br/>
为了提升用户支付体验，建议不设置手续费，但是可以在用户提现时适当收费
</td>
</tr>
<tr>
...
<input type="radio" name="pay[alipay][enable]" value="0"  <?php if(!$alipay['enable']) echo 'checked';?> onclick="Dd('alipay').style.display='none';"/> 禁用&nbsp;&nbsp;&nbsp;&nbsp;<a href="<?php echo DT_PATH;?>api/redirect.php?url=https://b.alipay.com/order/productDetail.htm?productId=2012111200373124" target="_blank" class="t">[帐号申请]</a>
</td>
</tr>
